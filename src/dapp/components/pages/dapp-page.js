        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 d-flex justify-content-end">
                    <button id="admin-button" class="btn btn-primary btn-lg nav-link" data-link="admin"><i class="fas fa-user-cog left"></i> Администрирование</button>
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-md-12">
            ...
            <div class="row mt-3">
                <div class="col-md-5">
                    <action-card 
                        ...
                        title="Кошелек" description="Получение кошелька"
